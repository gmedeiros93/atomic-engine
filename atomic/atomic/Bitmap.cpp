...
Bitmap::Bitmap(unsigned width, unsigned height,
	Format format, const unsigned char* pixels)
{
	_pixels = NULL;
...
Bitmap Bitmap::fromFile(std::string filePath)
{
...
unsigned int Bitmap::width() const { return _width; }
unsigned int Bitmap::height() const { return _height; }
Bitmap::Format Bitmap::format() const { return _format; }
unsigned char* Bitmap::pixelBuffer() const { return _pixels; }
